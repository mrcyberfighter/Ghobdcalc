...
| web site where you fetch this programme (www.cyber-sanktuary.fr)             |
...
|    the current base and|or converting the current value in the wanted base.  |
|                                                                              |
...
|                                                                              |
|       -) The DEG | RAD toggle buttons set the values to be take in charge    |
...
|                                                                              |
|       Ghobdcalc provide an memory for registering specific values for        |
|       resusing it later.                                                     |
|                                                                              |
